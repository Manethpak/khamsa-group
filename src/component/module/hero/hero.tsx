    ...
    <div>
      <div className="h-[880px] w-full">
        ...
        <div className="absolute inset-0 top-0">
          <Navbar />
          <div className="flex flex-col gap-24 md:pt-60 2xl:pt-56">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <motion.div
              ...
              className="mx-10 flex flex-col overflow-clip items-center gap-4 text-sm font-medium text-gray-400 md:max-w-4xl justify-center md:mx-auto"
            >
              <p>Our affiliate companies</p>
              <div
                className="w-full flex gap-24 relative "
                style={
                  {
              ...
              >
                ...
                className="relative flex gap-24 min-w-max">
                  {[...logo,...logo].map((data) => (
