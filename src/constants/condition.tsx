...
export const Condition = [
  ...
  {
    title: '1. Definitions',
    desc2: 'For the purposes of these Terms and Conditions:',
    description: (
      <>
        <p>
        ...
        <p>
          <strong>1.5 “Service”</strong> refers to the Website.
        </p>
        <p>
          <strong>1.6 “​ Terms and Conditions ​”</strong>
        ...
        <p>
          <strong>1.7 “ Third-party Social Media Service ”</strong>means any
        ...
        <p>
          <strong>1.8 “Website ”</strong>refers to Khamsa Group of Businesses,
          accessible from{' '}
          <Link href="https://www.khamsagroup.com" className="border-b">
            https://www.khamsagroup.com
          </Link>
        </p>
        <p>
          <strong>1.9 “ You ”</strong> means the individual accessing or using
    ...
    description: (
      <>
        ...
        <p>
          ...
          <br />
          <strong> (ii) </strong>
          that the Service will be uninterrupted or error-free. <br />
          <strong>(iii) </strong>as to the accuracy, reliability, or currency of
          any information or content provided through the Service. <br />
          <strong> (iv) </strong>that the Service, its servers, the content, or
  ...
  {
    title: '10. United States Legal Compliance',
    description: (
      <>
        <p>
  ...
  {
    title: '11. Severability and Waiver',
    description: (
      <>
        <p>
          <strong>11.1 Severability </strong> If any provision of these Terms is
          held to be unenforceable or invalid, such provision will be changed
  ...
  {
    title: '13. Translation Interpretation',
    description: (
      <>
        <p>
  ...
  {
    title: '14. Changes to These Terms and Conditions',
    description: (
      <>
        <p>
    ...
    description: (
      <>
        <p>
          ...
          contact us:​
          <p>
            ​By visiting this page on our website at :
            <Link href="/contact" className="border-b">
              www.khamsagroup.com/contact
            </Link>
          </p>
        </p>
      </>
