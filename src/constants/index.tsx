export const logo = [
  {
    id: '1',
    Image: '/images/logo1.avif',
  },
  {
    id: '2',
    Image: '/images/logochiptree.avif',
  },
  {
    id: '3',
...
export const Investments = [
  {
    ...
    title: 'AgriTech',
    description: 'agribusiness and industrial zones',
  },
  {
    id: '2',
    Image: '/images/Estate.svg',
    title: 'Real Estate',
    description: 'real estates and natural resort zones',
  },
  {
    id: '3',
    Image: '/images/BioTech.svg',
    title: 'BioTech',
    description: 'biotechnology and nano materials',
  },
  {
    id: '4',
    Image: '/images/AI.svg',
    title: 'AI & Software',
    description: 'next generation artificail intelligence and saas',
  },
  {
    id: '5',
    Image: '/images/FinTech.svg',
    title: 'FinTech',
    description: 'banking, gold, stock, blockchain, crypto, nft',
  },
  {
    id: '6',
    Image: '/images/Knowledge.svg',
    title: 'Knowledge',
    description: 'learning resources and broadcasting investment',
  },
  {
    id: '7',
    Image: '/images/EdTech.svg',
    title: 'EdTech',
    description: 'enables personalized learning experiences',
  },
  {
    id: '8',
    Image: '/images/CleanTech.svg',
    title: 'CleanTech',
    description: 'sustainable solutions to pressing environmental challenges',
  },
  {
    id: '9',
    Image: '/images/Robotics.svg',
    title: 'Robotics',
    description: 'enhances efficiency by automating repetitive tasks',
  },
]
...
export const Teams = [
  ...
  {
    name: 'LIM Dalin',
    Image: '/images/Account.jpeg',
    position: 'Account & Tax Executive',
  },
]
...
export const InOurs = [
  ...
  },
  {
    ...
    special: true,
    description:
      'Auto-Bot, Humanoid, Cyborg, Micron, Bionic, Satellite, Space Science, Fly Sciences, 3D Factory, Quantum Mechanics, Nitride Chip (brainless-robot-chip)',
  },
  {
    id: '4',
...
export const Condition = [
  {
    ...
    descriptions: (
      <>
        <p>
          This Framer Terms of Service <strong>(“Agreement”)</strong> is entered
          into by and between Framer B.V.
          <strong>(“Framer”)</strong> and the entity or person placing an order
          for or accessing the Services <strong>(“Customer”)</strong>. This
  ...
  },
  {
    ...
    description: (
      <>
        <p>
          <strong>1.1 “Authorized Devices​”</strong> means those mobile,
          desktop, or other devices with which the Services can be accessed and
          used.
        </p>
        <p>
          <strong>1.2 “​Content​”</strong> means code, content, fonts, graphics,
          designs, documents, or materials created using the Services by
          Customer and its Users or imported into the Services by Customer and
          its Users.
        </p>
        <p>
          <strong>1.3 “Documentation”</strong> ​means the technical materials
          made available by Framer to Customer and/or its Users in hard copy or
        ...
        <p>
          ...
          Parties identifying the Enterprise Services to be made available by
          Framer pursuant to this Agreement.
        </p>
        <p>
          <strong>1.6 “​Packages​”</strong> or <strong>“Components”</strong>{' '}
        ...
        <p>
          ...
          individual associated with Customer who has been provisioned by
  ...
  {
    title: '2. License and Use Rights',
    description: (
      <>
        <p>
          <strong>2.1 Services.</strong> Framer hereby grants Customer a
        ...
        <p>
          ...
          Customer the necessary passwords, security protocols, policies,
          network links or connections (“Access Protocols”) to allow Customer
          and its Users to access the Services as described herein; no other
          access to the website or servers from which the Services are delivered
        ...
        <p>
          ...
          Users will need to register and create an account, which requires the
        ...
        <p>
          ...
          will not authorize any User to:
        </p>
        <p>
          a) reverse look-up or trace any information of any other user or
          visitor or otherwise use the Services for the purpose of obtaining
          information of any other user or visitor;
        </p>
        <p>b) transmit spam, chain letters, or other unsolicited email;</p>
        <p>
          c) upload invalid data, viruses, worms, or other software agents
          through the Service;
        </p>
        <p>
          d) impersonate another person or otherwise misrepresent your
          affiliation with a person or entity, conduct fraud, hide, or attempt
          to hide your identity;
        </p>
        <p>
          e) disclose any information that Customer does not have the consent to
          disclose (such as confidential information of others, including their
        ...
        <p>
          ...
          data to analyze individuals or groups of natural persons for unlawful
          or discriminatory purposes;
        </p>
        <p>
          h) use the Services or any Content for any purpose that is unlawful or
          prohibited by the Agreement;
        </p>
        <p>
          i) store or collect any personally identifiable information that is
          deemed sensitive or requires special protections under applicable
          laws. For example, Social Security numbers, passwords, and credit card
          information;
        </p>
        <p>j) copy or duplicate the Services;</p>
        <p>
          k) decompile, disassemble, reverse engineer or otherwise attempt to
          obtain or perceive the source code from which any software component
          of the Services is compiled or interpreted;
        </p>
        <p>
          l)  modify the Services or the Documentation, or create any derivative
          work from any of the foregoing, except with the prior written consent
          of Framer;
        </p>
        <p>
        ...
        <p>
          o) damage, interfere with or disrupt the integrity, performance or use
          of the Services;
        </p>
        <p>
          p) use the Services for any purposes prohibited by law, including
        ...
        <p>
          r) submit, transmit or display any Content, or use Content in a
          context, which may be deemed as defamatory, libelous, obscene,
          harassing, threatening, incendiary, abusive, racist, offensive,
          deceptive or fraudulent, encouraging criminal or harmful conduct, or
          which otherwise violates the rights of Framer or any third party
          (including any intellectual property rights, privacy rights,
          contractual or fiduciary rights), or otherwise shows any person,
          entity or brand in a bad or disparaging light, without their prior
          explicit approval.
        </p>
        <p>
        ...
        <p>
          ...
          Content displayed in the Services does not and will not violate any
          law or infringe any rights of any third party, including without
          limitation any Intellectual Property Rights, publicity rights, or
          rights of privacy. Customer and its Users shall not display Content
          that:
        </p>
        <p>
          a)   is used for unlawful purposes or the promotion of illegal
          activities;
        </p>
        <p>
          b)   is used in a way that could be detrimental to the reputation of
          Framer;
        </p>
        <p>
          {' '}
          c) infringes intellectual property rights of third parties, would
          violate laws applicable to the Content or would cause Framer to
        ...
        <p>
          ...
          including measures that prevent or restrict use or copying of the
          Content or enforce limitations on the use of the Services or material
          accessible via the Services;
        </p>
        <p>
          f) may create a risk of harm, loss, damage, physical or mental injury,
          emotional distress, death, disability, disfigurement, or physical or
          mental illness to you, to any other person, to any animal or to any
          property;
        </p>
        <p>
          g)   may seek to harm or exploit children by exposing them to
          inappropriate content, asking for personally identifiable details or
          otherwise;
        </p>
        <p>h) may constitute or contribute to a crime or tort;</p>
        <p>
          i) contains any information or content that is deemed to be unlawful,
          harmful, abusive, racially or ethnically offensive, defamatory,
          infringing, harassing, humiliating to other people (publicly or
          otherwise), libelous, threatening, profane, or otherwise objectionable
          by Framer;
        </p>

        <p>
          j) contains software or other material that violates or invades the
          intellectual property rights (or rights of privacy or publicity) of
          any third party;
        </p>
        <p>
          k) includes any information or content to which the Customer or User
          has not obtained any necessary rights or permissions to use
          accordingly or to make available under any law or under contractual or
        ...
        <p>
          n) is adult in nature, such as any nudity in a sexual context, or any
          content with adult themes; or
        </p>
        <p>
          o) uses the Services for any purpose other than to upload and share
          Content in accordance with this Agreement.
        </p>
        <p>
          Framer reserves the right, but is not obligated, to reject and/or
          remove any User Content that Framer believes, in its sole discretion,
        ...
        <p>
          ...
          support services, Framer shall provide Customer with the following
          standard support: (a) email support to Users Monday through Friday,
          09:00 – 17:00 CET/CEST, Dutch holidays excluded, for problem
          resolution assistance; (b) commercially reasonable efforts to correct
          errors in the Services reported to Framer in writing; and (c) at the
          sole discretion of Framer, the provision of updates, upgrades,
          enhancements, and any other improvements that Framer makes generally
          available to subscribers of the Services.
        </p>
      </>
    ),
  },
  {
    ...
    description: (
      <>
        <p>
          <strong>3.1 No IP Rights Transfer.</strong> Other than the licenses
          described herein, no intellectual property rights are transferred by
          either Party to the other pursuant to this Agreement.
        </p>
        <p>
          <strong>3.2 What Framer Owns.</strong> Except for Content, Framer
          shall own all rights, including, but not limited to, all copyright
          rights in the Services, including any content or trademarks text,
          graphics, user and visual interfaces, photographs, logos, sounds,
        ...
        <p>
          ...
          are owned by the persons or entities who create them.
        </p>
        <p>
          <strong>3.5 Templates.</strong> Framer posts a list of templates
          created by Framer or users of the Service. Templates may be created by
    ...
    description: (
      <>
        ...
        <p>
          ...
          state, country, territory, or other jurisdiction. Customer owns all of
          the Content posted or published through the Services.
        </p>
        <p>
          <strong>4.2</strong> Framer is not responsible or liable for the
          Content or the consequences of uploading the Content or for sharing
          the Content. Framer does not endorse the Content or any advice,
          suggestion, or opinion expressed in the Content.
        </p>
        <p>
          <strong>4.3</strong> Although Framer has no obligation to monitor
          Content, Framer may do so and may remove Content and/or prohibit any
          use of the Services it believes may be (or alleged to be) in violation
          of the license and use rights set out in Section 2 of this Agreement.
        </p>
        <p>
          <strong>4.4 License to Display Content.</strong> Customer grants: (a)
          Framer a worldwide, non-exclusive, royalty-free, transferable license
          with a right to sub-license to use, reproduce, distribute, display and
          perform the Content to the extent required for the provision of the
          Services; and (b) individuals with whom Content is shared via the
          Services a personal, non-exclusive, royalty- free license to access
          the Content and to use the Content in accordance with the terms of
          this Agreement. The foregoing license terminates automatically when
          Content is removed from the Services. Customer understands and agrees
          that part of the Services is a public platform and other users may
          search for, see, use, and/or re-post any Content that Customer makes
          publicly available through the Service.
        </p>
        <p>
          <strong>4.5 Feedback.</strong> Customer may choose to or Framer may
          invite Customer to submit feedback about the Service, including
          without limitation about how to improve the Services or our products
          (“Feedback”). By submitting any Feedback, Customer agrees that
          disclosure is without restriction and will not place Framer under any
          fiduciary or other obligation. Framer is free to use the Feedback
          without any additional compensation to Customer, and/or to disclose
          the Feedback on a non-confidential basis or otherwise to anyone.
        </p>
      </>
    ),
  },
    ...
    description: (
      <>
        ...
        <p>
          ...
          reasonable efforts to protect information collected from End Users via
          the use of the Services, including any personal data obtained from
          unauthorized access or use. In the event Customer discovers that the
          End User information collected by Customer has been breached,
          compromised, or inadvertently exposed to non- authorized third
          parties, Customer shall notify Framer of such a breach or exposure
          within 72 hours including the root cause, remediation steps, and
          compensating controls to ensure such a breach does not occur in the
          future.
        </p>
        <p>
          <strong>c) Security Notification.</strong> Customer is responsible for
          providing notification to its End Users, third parties, or authorities
        ...
        <p>
          ...
          Customer uses and shares such information (including for marketing and
          advertising) with Framer and other third parties.
        </p>
        <p>
  ...
  },
  {
    ...
    description: (
      <>
        <p>
          <strong>6.1</strong> Framer will use procedural, technical, and
          administrative safeguards designed to ensure the confidentiality,
          security, integrity, availability, and privacy of Content and other
          Customer Confidential Information stored in the Services. Framer
  ...
  },
  {
    ...
    description: (
      <>
        <p>
          <strong>7.1 Confidential Information.</strong> Subject to the
          limitations set forth in Section 6.2, all information disclosed by one
          party to the other party during the term of this Agreement that is
          identified in writing at the time of disclosure as confidential or
          that reasonably should be understood to be confidential given the
          nature of the information and the circumstances of the disclosure,
          whether in oral, written, graphic, electronic, or other form, shall be
          deemed to be “​Confidential Information​”. The existence and terms of
          this Agreement are Confidential Information of both parties.
        </p>
        <p>
          <strong>7.2 Exceptions.</strong> Information will not be considered
          Confidential Information if the receiving party can establish by
          documentary evidence that the information is or was: (a) is publicly
        ...
        <p>
          ...
          either Party may disclose Confidential Information to the other Party.
          Each ​Party agrees that all items of Confidential Information are
          proprietary to the disclosing Party or such third party, as
          applicable, and will remain the sole property of the disclosing Party
          or such third party. Each Party further agrees: (a) to use
        ...
        <p>
          ...
          or other governmental body, or as otherwise necessary to comply with
          applicable law or legal requirement, provided that the receiving Party
          shall first have given notice to the disclosing Party (to the extent
          permitted) and shall have provided assistance to the disclosing Party
          as may be reasonably requested to limit such disclosure.
        </p>
      </>
    ),
  },
    ...
    description: (
      <>
        ...
        <p>
          ...
          license, Customer may contact Framer separately.
        </p>
        <p>
          <strong>8.4 Authorization of Recurring Payments.</strong> All pricing
          plans involve recurring fees (each, along with any applicable taxes
          and other charges). Customers on a monthly payment plan will be
          ...
          your self-service subscription will automatically-renew for the same
          term as the initial term.
        </p>
        <p>
          Unless otherwise agreed in the applicable Order Form, Enterprise
          Customers will be notified in writing if they exceed their purchased
          inclusions. Overuse will be billed pro rata through the end of the
          subscription term. An invoice or payment link will be sent to the
        ...
        <p>
          ...
          Paddle) will automatically charge Customer in accordance with the term
  ...
  },
  {
    ...
    description: (
      <>
        <p>
          <strong>9.1 Authority.</strong> Each of Framer and Customer represents
          and warrants that: (a) it has the full right, power and authority to
          enter into and fully perform this Agreement; (b) the person signing
          this Agreement on its behalf is a duly authorized representative of
          such party who has in fact been authorized to execute this Agreement;
          (c) its entry herein does not violate any other agreement by which it
          is bound, and (d) it is a legal entity in good standing in the
          jurisdiction of its formation.
        </p>
        <p>
          <strong>9.2 Rights to Content.</strong> Customer warrants that it has
          and will continue to have during the Term all necessary licenses,
          rights, consents, and permissions which are required to enable Framer
          to use the Content as required to provide the Services.
        </p>
        <p>
          <strong>9.3 Disclaimer.</strong> The Services are intended for
          hosting, design and prototyping of web and app pages. To the maximum
          extent permitted by applicable law, the Services, Packages,
          Components, Templates, content and related services are provided “as
          is,” and Framer disclaims any and all other representations and
    ...
    description: (
      <>
        <p>
          ...
          business interruption, costs of lost or damaged data, or liabilities
          to third parties arising from any source, even if such party has been
          advised of the possibility of damages; and (b) the cumulative
          liability of Framer to Customer for all claims arising from this
          agreement, including, without limitation, any cause of action sounding
  ...
  },
  {
    ...
    description: (
      <>
        <p>
          <strong>11.1 By Framer.</strong> Framer will defend at its expense any
          suit brought against Customer by a third party, and will pay any
          settlement Framer makes or approves, or any damages finally awarded in
          such suit, insofar as such suit is based on a claim by any third party
          alleging that the Services (excluding Packages, Components, Templates,
          and Content) misappropriates any trade secret recognized under the
          Uniform Trade Secrets Act or infringes any copyright or trademark
          issued as of the Effective Date. Notwithstanding the foregoing, Framer
          shall have no obligation under this section or otherwise with respect
          to any infringement claim based upon (a) any use of the Services not
          in accordance with this Agreement; (b) any use of the Services in
          combination with other products, equipment, software or data not
          supplied by Framer; (c) any modification of the Services by any person
          other than Framer or its authorized agents; or (d) Content, Packages,
          Components, or Templates created by Customer or other third parties.
          If, due to a claim of infringement, the Services are held by a court
          of competent jurisdiction to be or is believed by Framer to be
          infringing, Framer may, at its option and expense: (x) replace or
          modify the Services to be non-infringing provided that such
          modification or replacement contains substantially similar features
          and functionality, (y) obtain for Customer a license to continue using
        ...
        <p>
          ...
          obligations are subject to the following: (a) the indemnified Party
          will promptly notify the indemnifying Party of any claim for which
  ...
  },
  {
    ...
    description: (
      <>
        <p>
          <strong>12.1 Term.</strong> Unless otherwise specified in a Order
          Form, the Term of this Agreement will commence on the Effective Date
          and will automatically renew for successive terms equal in duration to
          the initial term unless Customer cancels their plan in advance of the
          renewal date.
        </p>
        <p>
        ...
        <p>
          ...
          terminate this Agreement in the event the other Party: (a) materially
          breaches this Agreement and fails to cure such breach (or provide an
          acceptable plan for curing such breach) within 30 days after receipt
          by the breaching Party of written notice specifying the breach; (b)
          ...
          instituted against such party (and not dismissed within 60 days). 
        </p>
        <p>
          Self-Service subscriptions have the right to terminate their account
          at any time in the
          <a
          ...
          . Such termination will be effective at the start of the next billing
          or renewal period. Termination is not an exclusive remedy and the
          exercise by either party of any remedy under this Agreement will be
          without prejudice to any other remedies it may have under this
          Agreement, by law, or otherwise.
        </p>
        <p>
          <strong>12.4 Suspension.</strong> If Customer fails to pay any
          undisputed amounts hereunder or, as necessary to protect the security
          of the Services, Framer will have the right, in addition to any of its
          other rights or remedies, to immediately suspend access to the
          Services to Customer and/or any of its User(s), without liability,
          until such amounts are paid in full or such threat no longer exists,
          as applicable.
        </p>
        <p>
          <strong>12.5 Effects.</strong> Upon termination or expiration of this
          Agreement, Customer will immediately discontinue use of the Services.
          Sections 3 (Ownership Rights), 7 (Confidentiality), 8 (Fees and
  ...
  },
  {
    ...
    description: (
      <>
        <p>
          <strong>13.1 Integration.</strong> This Agreement is the entire
          agreement between the Parties related to the subject matter hereof and
          supersedes all prior and contemporaneous agreements, understandings
          and discussions. You and Framer B.V. waive their rights to rescind or
        ...
        <p>
          ...
          and the remainder of this Agreement will continue in full force. No
          waiver hereunder will be valid or binding unless set forth in writing
          and duly executed by the Party against whom enforcement of such waiver
          is sought.
        </p>
        <p>
          <strong>13.3</strong> No Agency Relationship; No Third Party
          Beneficiaries​. Nothing in this Agreement will be construed to create
          any agency, partnership, or joint venture between the Parties, and
          neither Party will represent itself as an agent or legal
          representative of the other Party. To the extent that any third party
          stipulation is contained in this Agreement, article 6:254 of the Dutch
          Civil Code is excluded. The Parties acknowledge that the covenants set
          forth in this Agreement are intended solely for the benefit of the
        ...
        <p>
          ...
          be governed by and interpreted in accordance with Dutch law without
          regard to international law regulations or principles of law leading
          to the application of other laws. The United Nations Convention on
          Contracts for the International Sale of Goods does not apply to this
          Agreement. Any dispute or claim arising out of or in connection with
          this Agreement, or the breach, termination or invalidity thereof shall
          be settled by arbitration in accordance with the International Chamber
          of Commerce (ICC) rules. Such dispute or claim shall be settled by
          simplified arbitration arranged by ICC in accordance with the rules of
          arbitration procedure adopted by ICC and in force at the time when
          such proceedings are commenced. Arbitration shall be conducted in
          Amsterdam, before one arbitrator appointed in accordance with the ICC
          Rules. All arbitration shall be conducted in English. The award
          rendered thereon by the arbitrator shall be final and binding on the
          Parties thereto, and judgment thereon shall be confidential and may be
          entered in any court of competent jurisdiction. Nothing in this
          Section 12.2 shall prevent either Party from applying to a court of
          competent jurisdiction for equitable or injunctive relief.
        </p>
        <p>
          <strong>13.6 Force Majeure.</strong> Any delay in the performance of
          any duties or obligations of either Party (except the payment of money
          owed) will not be considered a breach of this Agreement if such delay
          is caused by any event beyond the control of such Party, provided that
          such Party uses reasonable efforts to notify the other Party of the
          cause of such delay and to resume performance as soon as possible.
        </p>
        <p>
          <strong>13.7 Notices.</strong> All notices, requests, and other
          communications to the other Party hereunder must be in writing to
          legal@framer.com
        </p>
        <p>
          ...
          party. Any other purported assignment shall be void.
        </p>
        <p>
          <strong>13.9 Counterparts.</strong> This Agreement may be executed and
          delivered by facsimile or electronic signature and in two or more
...
export const Footer = [
  { title: 'Company Directory', url: '/company-directory' },
