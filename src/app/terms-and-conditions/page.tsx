...
const TermCondition = () => {
  return (
    <article className="prose mx-auto max-w-4xl text-pretty px-4 py-4 font-manrope prose-headings:text-deepGreen">
      <h1>Terms and Conditions</h1>
      <p>V 2.0 Last updated: December 11, 2024</p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Khamsa Group of Businesses, Building#3,
            St39D, Anlungkung Village, Preysor District, Dangkor Commune, Phnom
            Penh, Cambodia.
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <Link
            href="https://www.khamsagroup.com/contact"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://www.khamsagroup.com/contact
          </Link>
        </li>
      </ul>
    </article>
