...
const page = () => {
  ...
  return (
    <div className="flex w-full flex-col items-center justify-center py-20 subtitle">
          ...
          <div className="flex w-full max-w-sm flex-col gap-6">
            ...
            <div className="flex flex-col gap-4 ">
              ...
              {(contact?.social_link || []).map((data) => {
                ...
                return (
                  <div key={data.title} className="border rounded-full justify-center items-center flex size-12">
